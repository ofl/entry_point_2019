  ...
  <nav class="navbar is-link is-fixed-top" role="navigation" aria-label="main navigation">
    ...
    >
      <div class="navbar-end">
        <a class="navbar-item" href="#" @click.stop.prevent="onClickMenu('/')">
          <span class="icon">
            <i class="fas fa-home"/>
          </span>
          <span>Home</span>
        ...
        <div class="navbar-item has-dropdown is-hoverable">
          ...
          <div class="navbar-dropdown">
            ...
            <RouterLink to="/gql_articles" class="navbar-item">
              <span class="icon">
                <i class="fas fa-file-alt"/>
              </span>
            ...
            <a class="navbar-item" href="/articles" @click.stop.prevent="onClickMenu('/articles')">
              <span class="icon">
                <i class="fas fa-file-alt"/>
              </span>
        ...
        <div v-if="isLoggedIn" class="navbar-item has-dropdown is-hoverable">
          ...
          <div class="navbar-dropdown">
            <RouterLink to="/profile/edit" class="navbar-item">
              <span class="icon">
                <i class="fas fa-file-alt"/>
              </span>
